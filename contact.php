...
<div class="container" style="margin:2px 193px 14px 102px;">
  <form action="contact.php"  method ="post" style="margin:11px 162px -33px 171px">
...
$f ="INSERT INTO farzana (firstname,lastname, email,country,message ) VALUES ('$fname','$lname','$email','$country','$message')";
mysqli_query($db,$f);
}
